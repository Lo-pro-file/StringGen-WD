...
async def gen_session(
    ...
    await Opleech.send_message(user_id, "» ᴛʀʏɪɴɢ ᴛᴏ sᴇɴᴅ ᴏᴛᴩ ᴀᴛ ᴛʜᴇ ɢɪᴠᴇɴ ɴᴜᴍʙᴇʀ...")
    if telethon:
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Opleech"))
        else:
            ...
            await client.join_chat("WD_Topic_Group")
    except KeyError:
        pass
    try:
